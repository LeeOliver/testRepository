...
@interface SJAlipayWebVC ()
@end

@implementation SJAlipayWebVC
@synthesize fundStr;
...
//    [topView addSubview:titleBtn];
    ...
    NSString *path = [NSString stringWithFormat:@"http://www.shijinzhifu.com/alipay/alipayapi2.php?alipay_amount=%@&userid=%@",self.fundStr,[NetWorkEngine shareInstance].userID];
