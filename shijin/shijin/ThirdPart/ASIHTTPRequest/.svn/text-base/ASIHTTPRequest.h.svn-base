...
@property (strong) NSString *proxyType;
...
@property (strong) NSString *temporaryUncompressedDataDownloadPath;
...
@property (unsafe_unretained) ASIHTTPRequest *mainRequest;
...
@property (strong, readonly) NSNumber *requestID;
@property (unsafe_unretained) id <ASICacheDelegate> downloadCache;
...
@property (strong) NSArray *clientCertificates;
#if TARGET_OS_IPHONE && __IPHONE_OS_VERSION_MAX_ALLOWED >= __IPHONE_4_0
@property (assign) BOOL shouldContinueWhenAppEntersBackground;
#endif
@property (strong) ASIDataDecompressor *dataDecompressor;
